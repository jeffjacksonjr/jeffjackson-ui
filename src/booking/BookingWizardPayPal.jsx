...
import PayPalCheckoutStep from './PayPalCheckoutStep';

export default function BookingWizardPayPal() {
                ...
                {availableDates.map((date) => {
                    ...
                    return (
                        <button
                            ...
                            className={`p-4 rounded-lg border ${selectedDate && selectedDate.getTime() === date.getTime()
                ...
                {availableTimes.length > 0 ? (
                    availableTimes.map((time) => (
                        <button
                            ...
                            className={`p-4 rounded-lg border ${selectedTime === time
                                    ? 'border-purple-500 bg-purple-900'
                                    : 'border-gray-700 hover:border-purple-400'
                                }`}
                        >
